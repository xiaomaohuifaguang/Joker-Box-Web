    ...
    <div class="page-container">
        ...
        <div class="breadcrumb-wrapper">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>CrawlerTask管理</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
            ...
            <div v-loading="loading" element-loading-text="加载中..."
                ...
                <el-card class="table-card" shadow="never">
                    <el-table :data="tableData" stripe border style="width: 100%"
                        ...
                        <el-table-column prop="createBy" label="创建人" min-width="150" />
        ...
        <!-- 添加对话框 -->
        <el-dialog v-model="dialogAdd" title="添加CrawlerTask" width="400px" center destroy-on-close @closed="queryPage">
