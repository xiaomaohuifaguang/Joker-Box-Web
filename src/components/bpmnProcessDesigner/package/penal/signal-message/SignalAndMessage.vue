<template>
  <div class="panel-tab__content">
    <div class="panel-tab__content--title">
      ...
      <el-button type="primary" title="创建新消息" preIcon="ep:plus" @click="openModel('message')">创建新消息</el-button>
    </div>
    ...
    <div class="panel-tab__content--title" style="padding-top: 8px; margin-top: 8px; border-top: 1px solid #eee">
      ...
      <el-button type="primary" title="创建新信号" preIcon="ep:plus" @click="openModel('signal')">
        创建新信号
      </el-button>
    </div>
    ...
    <el-dialog v-model="dialogVisible" :title="modelConfig.title" :close-on-click-modal="false" width="400px"
