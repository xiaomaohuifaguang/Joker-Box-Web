...
<template>
  <div>
    ...
    <el-form-item prop="rejectHandlerType">
      <el-radio-group v-model="rejectHandlerType" :disabled="returnTaskList.length === 0"
    ...
    <!-- <el-form-item v-if="assignEmptyHandlerType == AssignEmptyHandlerType.ASSIGN_USER" label="指定用户"
      prop="assignEmptyHandlerUserIds" span="24">
    ...
    <div class="button-setting-pane">
      ...
      <div class="button-setting-item" v-for="(item, index) in buttonsSettingEl" :key="index">
        ...
        <div class="button-setting-item-label">
          ...
          <el-button v-else text @click="changeBtnDisplayName(index)">{{ item.displayName }} &nbsp;
            <!-- <Icon icon="ep:edit" /> -->
          </el-button>
        </div>
        <div class="button-setting-item-label">
      ...
      <div class="field-setting-item" v-for="(item, index) in fieldsPermissionEl" :key="index">
        ...
        <el-radio-group class="field-setting-item-group" v-model="item.permission">
          <div class="item-radio-wrap">
            <el-radio :value="FieldPermissionType.READ" size="large"
              :label="FieldPermissionType.READ"><span></span></el-radio>
          </div>
          <div class="item-radio-wrap">
            <el-radio :value="FieldPermissionType.WRITE" size="large"
              :label="FieldPermissionType.WRITE"><span></span></el-radio>
          </div>
          <div class="item-radio-wrap">
            <el-radio :value="FieldPermissionType.NONE" size="large"
              :label="FieldPermissionType.NONE"><span></span></el-radio>
          </div>
        </el-radio-group>
      </div>
    </div> -->
