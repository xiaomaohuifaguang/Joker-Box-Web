    ...
    <el-table :data="elementListenersList" size="small" border>
      ...
      <el-table-column label="操作" width="90px">
        <template #default="scope">
          ...
          <el-button size="small" link style="color: #ff4d4f"
            @click="removeListener(scope.row, scope.$index)">移除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <div class="element-drawer__button">
      <el-button size="small" type="primary" preIcon="ep:plus" title="添加监听器" @click="openListenerForm(null)">
        添加监听器
      </el-button>
      <el-button type="success" preIcon="ep:select" title="选择监听器" size="small"
        @click="openProcessListenerDialog">选择监听器</el-button>
    </div>
      ...
      <el-table :data="fieldsListOfListener" size="small" max-height="240" fit border style="flex: none">
        ...
        <el-table-column label="操作" width="100px">
          <template #default="scope">
            ...
            <el-divider direction="vertical" />
            <el-button size="small" link style="color: #ff4d4f"
              @click="removeListenerField(scope.row, scope.$index)">移除</el-button>
          </template>
        </el-table-column>
      </el-table>
