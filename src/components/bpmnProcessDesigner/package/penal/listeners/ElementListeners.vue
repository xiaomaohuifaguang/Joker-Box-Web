<template>
  <div class="panel-tab__content">
    ...
    <div class="element-drawer__button">
      <el-button type="primary" preIcon="ep:plus" title="添加监听器" size="small"
    ...
    <el-drawer v-model="listenerFormModelVisible" title="执行监听器" :size="`${width}px`" append-to-body destroy-on-close>
      ...
      <p class="listener-filed__title">
        ...
        <el-button type="primary" @click="openListenerFieldForm(null)" title="添加字段">添加字段</el-button>
      </p>
        ...
        <el-table-column label="操作" width="130px">
          <template #default="scope">
            ...
            <el-button size="small" link style="color: #ff4d4f"
              @click="removeListenerField(scope.$index)">移除</el-button>
          </template>
        </el-table-column>
      </el-table>
