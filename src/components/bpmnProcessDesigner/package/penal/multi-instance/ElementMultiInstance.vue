      ...
      <div class="flex-col">
        <div v-for="(item, index) in APPROVE_METHODS" :key="index">
          ...
          <el-form-item prop="approveRatio">
            <el-input-number v-model="approveRatio" :min="10" :max="100" :step="10" size="small" v-if="
    ...
    <el-form label-width="90px" style="display: none">
      ...
      ">
        ...
        <el-form-item label="异步状态" key="async" style="display: none">
          <el-checkbox v-model="loopInstanceForm.asyncBefore" label="异步前" value="异步前"
            @change="updateLoopAsync('asyncBefore')" />
          <el-checkbox v-model="loopInstanceForm.asyncAfter" label="异步后" value="异步后"
            @change="updateLoopAsync('asyncAfter')" />
          <el-checkbox v-model="loopInstanceForm.exclusive"
            v-if="loopInstanceForm.asyncAfter || loopInstanceForm.asyncBefore" label="排除" value="排除"
...
import { ApproveMethodType, APPROVE_METHODS } from '@/components/bpmnProcessDesigner/src/consts'
